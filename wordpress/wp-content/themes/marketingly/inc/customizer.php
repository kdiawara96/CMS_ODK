 ...
 */
function marketingly_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	$wp_customize->get_section('header_image')->title = __( 'Header Settings', 'marketingly' );
	$wp_customize->get_section('colors')->title = __( 'Background Color', 'marketingly' );

	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			'selector'        => '.site-title a',
			'render_callback' => 'marketingly_customize_partial_blogname',
			) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'marketingly_customize_partial_blogdescription',
			) );
	}

	$wp_customize->add_section( 'sidebar_settings', array(
		'title'      => __('Sidebar Settings','marketingly'),
		'priority'   => 1,
	...
	$wp_customize->add_control( 'sidebar_hide', array(
		'label'    => __( 'Hide Sidebar', 'marketingly' ),
...
add_action( 'customize_register', 'marketingly_customize_register' );




if(! function_exists('marketingly_customizer_css_final_output' ) ):
	function marketingly_customizer_css_final_output(){
		?>
	...
	<?php }
	add_action( 'wp_head', 'marketingly_customizer_css_final_output' );
	endif;
 ...
 * @return void
 */
function marketingly_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function marketingly_customize_partial_blogdescription() {
 ...
 */
function marketingly_customize_preview_js() {
	wp_enqueue_script( 'marketingly-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'marketingly_customize_preview_js' );
